---
title: "SNAP - StaMPS workflow for PS processing - 2.0"
...
At the moment, the document describes the processing in StaMPS for version 3.x, the latest version is 4.x, keep this in mind while reading. Preprocessing in SNAP has not changed until now.
...
To give a full introduction even to users which have not worked with the SNAP Toolbox etc., the document starts with installing a Unix based OS, software and their configurations you need during the workflow. If you are already familiar with all the software needed, skip these sections and move on to the processing part you are interested in.  
...
mv /home/user/Downloads/StaMPS_v3.3b1.tar.gz /home/user/
...
```{r fig.width=7, fig.height=5, echo = F, fig.align='center', eval = T, fig.cap='Edge of a burst of a Sentinel-1 IW SLC product.'}
...
To get rid of the effects on the edges shown in the last section, the TOPSAR-Deburst operator is used. Hence the stack was created using the GUI I recommend to open spyder again and continue processing in python, because it is again a single step, you can even use the GUI, that is on you.
...
####################
out_form = ".dim"
inpath = '/home/thho/psstack/20170310_Stack_deb.dim'
outpath_substack = '/home/thho/psstack/20170310_PS_subset' + out_form
subpoly_path = '/home/thho/studysiteinfo/subset.geojson'
